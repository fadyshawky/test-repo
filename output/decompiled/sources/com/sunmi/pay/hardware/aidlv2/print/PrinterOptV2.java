...
/* loaded from: classes.jar:com/sunmi/pay/hardware/aidlv2/print/PrinterOptV2.class */
public interface PrinterOptV2 extends IInterface {
    ...
    /* loaded from: classes.jar:com/sunmi/pay/hardware/aidlv2/print/PrinterOptV2$Default.class */
    public static class Default implements PrinterOptV2 {
        ...
        @Override // com.sunmi.pay.hardware.aidlv2.print.PrinterOptV2
        public void registerPrintCallback(PrinterCallbackV2 callback) throws RemoteException {
        }
    ...
    /* loaded from: classes.jar:com/sunmi/pay/hardware/aidlv2/print/PrinterOptV2$Stub.class */
    public static abstract class Stub extends Binder implements PrinterOptV2 {
        ...
        public static PrinterOptV2 asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin != null && (iin instanceof PrinterOptV2)) {
                return (PrinterOptV2) iin;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    PrinterCallbackV2 _arg04 = PrinterCallbackV2.Stub.asInterface(data.readStrongBinder());
        ...
        /* loaded from: classes.jar:com/sunmi/pay/hardware/aidlv2/print/PrinterOptV2$Stub$Proxy.class */
        private static class Proxy implements PrinterOptV2 {
        ...
        public static boolean setDefaultImpl(PrinterOptV2 impl) {
